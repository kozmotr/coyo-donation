...
import com.coyo.mailservice.aop.Importance;
import com.coyo.mailservice.aop.Queue;
import com.coyo.mailservice.utils.MailTemplateGenerator;
...
public class MailService {
    ...
    @Queue
    public void sendInvitationTokenMail(String token) {
        final Map<String, Object> args = new HashMap<>();
        args.put("activationCode", token);
